    ...
    <PermissionGate module="admin" fallback={
      ...
      <div className="space-y-6">
        ...
        {tab === 'devices' && (
          <GlassCard>
            <div className="flex items-center justify-between mb-4">
              <div className="text-white/40 text-sm font-outfit">Registered devices</div>
              <span className="text-xs px-2 py-1 rounded-full bg-green-500/10 text-green-400 border border-green-500/20">All compliant</span>
            </div>
            <div className="space-y-2">
              {employees.slice(0, 5).map((emp, i) => (
                <div key={emp.id} className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/[0.02] border border-white/[0.04]">
                  ...
                  <div className="flex-1">
                    <div className="text-white/80 text-sm font-outfit">{emp.name}</div>
                    <div className="text-white/30 text-xs font-geist">DESKTOP-{1000 + i} · Windows 11</div>
                  </div>
                  <span className="text-xs px-2 py-1 rounded-full bg-green-500/10 text-green-400 border border-green-500/20">Compliant</span>
                </div>
              ))}
            </div>
          </GlassCard>
